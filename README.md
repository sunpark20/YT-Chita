...
### v1.2.9 (2026-03-14)
- 일부 Windows 환경에서 서버 시작 실패하던 문제 수정 (uvicorn 로깅 설정 오류)

### v1.2.8 (2026-03-14)
- Windows에서 앱 실행 시 무반응/무음 크래시 문제 수정 (에러 MessageBox 표시)
- 포트 충돌 시 자동으로 다음 포트(8001~8009) 탐색 후 실행
- 채널/플레이리스트 최대 분석 영상 수 500 → 2000으로 확대

### v1.2.7
- 구버전 윈도우에서 WebView2가 없어 실행이 안되는 문제 — 앱시작시 WebView2 자동설치 추가
